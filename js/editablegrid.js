...
EditableGrid.prototype.init = function (name, config)
{
	...
	if (this.enableSort) {
		...
		if ( typeof config != "undefined" && typeof config['sortIconUp'] != "undefined" ) 
			...
			this.sortUpImage.src = "imagenes/grilla/bullet_arrow_up.png";
		...
		if ( typeof config != "undefined" && typeof config['sortIconDown'] != "undefined" ) 
			...
			this.sortDownImage.src = "imagenes/grilla/bullet_arrow_down.png";
	}
...
EditableGrid.prototype.beforeRender = function(containerid, className, tableid) {};
