...
<br />
<br />
Desde esta opción puede gestionar los orígenes de las consultas del CRM.
<br />
Tenga en cuenta que los cambios realizados se aplicarán inmediatamente a las consultas enlazadas a cada origen.
<br />
<br />
...
<div id="divOrigenes" class="grilla"></div>        
<script type="text/javascript">var grd = new DatabaseGrid("<?= $gDbDatabase ?>", "origenes", "divOrigenes", <?= usuarioID() ?>);</script>
